      ...
      <Disclosure as="nav" className="bg-white">
        {({ open }) => (
          <div className="items-centre flex">
                ...
                >
                  <div
                    className={classNames(
                      ...
                      "px-3 py-2 rounded-md text-sm font-medium ml-5 h-fit cursor-pointer"
                    )}
                  >
                    {item.name}
                  </div>
            ...
            <div className="items-centre h-full">
              <div className="-mr-2 flex sm:hidden items-center">
                {/* Mobile menu button */}
                <Disclosure.Button className="h-fit bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
